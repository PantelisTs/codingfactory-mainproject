...
import gr.aueb.cf.cf9.ch16.copy_constructor.City;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Set - Update
        int position = cities.indexOf("Paris");   // override equals if we had different class than String
        if (position == -1) {
        ...
        while (it.hasNext()) {
            if (it.next().equals("Tokyo")) {
                it.remove();             // cities.remove("Tokyo"); fails fast
            }
        }
